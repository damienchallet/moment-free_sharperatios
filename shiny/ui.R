...
shinyUI(fluidPage(
 ...
 sidebarLayout(
    sidebarPanel(
      ...
      numericInput("Tin","calibration length",value = 252),
      ...
      helpText("The moment-free estimator is more robust, precise (efficient), and does not over-estimate Sharpe ratios in wild market conditions."),
      br(),
